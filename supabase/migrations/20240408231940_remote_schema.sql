...
COMMENT ON TABLE "public"."user_info" IS 'Information about a user';
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."user_info" TO "authenticated" USING (("auth"."uid"() = "auth_id"));
